...
function User({ className, property1 = "Default" }: UserProps) {
  return (
...
function ShoppingBasket({ className, property1 = "Default" }: ShoppingBasketProps) {
  return (
...
type MoreProps = {
  className?: string;
  property1?: "Variant3" | "Variant2";
};

function More({ className, property1 = "Variant3" }: MoreProps) {
  return (
...
function ArrowSwapHorizontal({ className, property1 = "Default" }: ArrowSwapHorizontalProps) {
  return (
