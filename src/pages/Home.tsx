...
function ProductCategoryCard({ title, mainImage, mainImageAlt, linkText, subCategories }: {
  ...
  mainImageAlt: string;
  linkText: string;
  subCategories: Array<{ image: string; imageAlt: string; linkText: string }>;
}) {
  return (
...
function FeaturesSection() {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-[20px] sm:gap-[16px] md:gap-[20px] lg:justify-between relative w-full max-w-[1240px] mx-auto px-[12px] sm:px-[16px] md:px-[40px] lg:px-[60px] xl:px-[100px] overflow-hidden" data-node-id="35:814">
      {features.map((feature, index) => (
        <div key={index} className="flex flex-col gap-[16px] sm:gap-[20px] md:gap-[24px] min-h-[140px] sm:h-[160px] items-center p-[8px] relative shrink-0 w-full sm:w-auto sm:flex-1">
          ...
          <div className="flex flex-col gap-[8px] sm:gap-[10px] md:gap-[12px] items-center justify-center leading-[normal] not-italic relative shrink-0 text-center w-full">
            <p className="font-['Poppins'] font-medium relative shrink-0 text-[#0f0f0f] text-[16px] sm:text-[18px] md:text-[20px]" dir="auto">
              {feature.title}
            </p>
            <p className="font-['Poppins'] font-normal relative shrink-0 text-[#666] text-[14px] sm:text-[15px] md:text-[16px]" dir="auto">
              {feature.description}
            </p>
          </div>
        </div>
  ...
  return (
    <div className="bg-white relative w-full min-h-screen" data-name="home" data-node-id="35:497">
      <div className="flex flex-col gap-[24px] sm:gap-[32px] md:gap-[40px] items-center relative w-full" data-node-id="35:498">
        ...
        {/* Features Section */}
        <div className="w-full max-w-[1240px] mx-auto lg:px-[100px] md:px-[60px] sm:px-[40px] px-[12px] py-[20px] sm:py-[24px] md:py-[32px] lg:py-[40px] overflow-hidden" data-node-id="35:814">
          <FeaturesSection />
        </div>
      </div>
    </div>
