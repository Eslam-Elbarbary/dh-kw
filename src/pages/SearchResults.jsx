...
export default function SearchResults() {
  ...
  const [selectedBrands, setSelectedBrands] = useState(['Apple', 'Microsoft', 'LG', 'HP', 'Panasonic']);
  ...
  // Sample products data - matching Figma exactly (node 35:3733)
  const products = Array.from({ length: 24 }, (_, i) => ({
    id: i + 1,
    name: "4K UHD LED Smart TV with Chromecast Built-in",
    brand: "Brand Name",
    originalPrice: "$1,50", // Original price with strikethrough
    salePrice: "$865", // Sale price in green
    image: productImage,
        ...
        <div className="max-w-[1240px] lg:max-w-[1400px] xl:max-w-[1600px] 2xl:max-w-[1800px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-[16px] sm:gap-[20px] md:gap-[40px]" data-node-id="35:2535">
            ...
            <div className="flex gap-[8px] items-center leading-[0] not-italic whitespace-nowrap" data-node-id="35:2536">
              <div className="flex flex-col font-['Poppins'] font-normal justify-center relative shrink-0 text-[#333] text-[14px] sm:text-[16px]" data-node-id="35:2537">
                <p className="leading-[18px]">Show: </p>
              </div>
              <div className="flex flex-col font-['Poppins'] font-semibold justify-center relative shrink-0 text-[#333] text-[14px] sm:text-[16px]" data-node-id="35:2538">
                <p className="leading-[18px]">15</p>
              </div>
              <div className="flex flex-col font-['Inter'] font-normal justify-center relative shrink-0 text-[#e6e6e6] text-[16px] sm:text-[18px]" data-node-id="35:2539">
                <p className="leading-[18px]">/</p>
              </div>
              <div className="flex flex-col font-['Poppins'] font-normal justify-center relative shrink-0 text-[#e6e6e6] text-[14px] sm:text-[16px]" data-node-id="35:2540">
                <p className="leading-[18px]">20</p>
              </div>
              <div className="flex flex-col font-['Inter'] font-normal justify-center relative shrink-0 text-[#e6e6e6] text-[16px] sm:text-[18px]" data-node-id="35:2541">
                <p className="leading-[18px]">/</p>
              </div>
              <div className="flex flex-col font-['Poppins'] font-normal justify-center relative shrink-0 text-[#e6e6e6] text-[14px] sm:text-[16px]" data-node-id="35:2542">
            ...
            <div className="flex gap-[22px] items-center relative shrink-0" data-name="Sort By" data-node-id="35:2583">
              <p className="font-['Poppins'] font-normal leading-[20px] not-italic relative shrink-0 text-[#191c1f] text-[14px]" data-node-id="35:2584">
                Sort by:
              </p>
              <div className="bg-white border border-[#e4e7e9] border-solid h-[40px] overflow-hidden relative rounded-[2px] shrink-0 w-[180px]" data-name="Dropdown" data-node-id="35:2585">
            ...
            >
              ...
              <div className="flex flex-col font-['Poppins'] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#333] text-[14px] sm:text-[16px] text-left whitespace-nowrap" data-node-id="35:2588">
                    ...
                    {products.slice(rowStart, rowStart + 4).map((product, idx) => {
                      return (
                        <Link
                          ...
                          className="bg-white border-[#e4e7e9] border-[0.849px] border-solid flex flex-col gap-[6.789px] items-start overflow-hidden p-[13.578px] rounded-[3.394px] w-full sm:w-[calc(50%-10.183px)] md:w-[calc(33.333%-13.577px)] lg:w-[calc((100%-61.098px)/4)] hover:shadow-lg transition-shadow cursor-pointer"
                          data-name="Product"
                        ...
                        >
                          ...
                          <div className="flex flex-col gap-[6.789px] items-start w-full" data-name="Content" data-node-id="35:3858">
                            <p className="font-['Poppins'] font-semibold leading-[16.972px] text-[#191c1f] text-[12px] w-full" data-node-id="35:3859">
                              {product.name}
                            </p>
                            <p className="capitalize font-['Poppins'] font-medium leading-[18.563px] text-[#999] text-[12px]" data-node-id="35:3860">
                              {product.brand}
                            </p>
            ...
            >
              ...
              <div className="flex flex-col gap-[24.078px] items-start p-[16px] sm:p-[20px] lg:p-[24px]">
                ...
                <div className="flex flex-col gap-[16.052px] items-start w-full" data-name="Category" data-node-id="35:4174">
                  <p className="font-['Poppins'] font-semibold leading-[24.078px] text-[#191c1f] text-[14px] sm:text-[16.052px] uppercase w-full" data-node-id="35:4175">
                    Category
                  </p>
                  <div className="flex flex-col gap-[12.039px] items-start w-full" data-name="Radio" data-node-id="35:4176">
                    {[
                      ...
                      >
                        {idx === 0 ? (
                          <div className="relative size-[20.065px] flex-shrink-0" data-name="From Elements" data-node-id="35:4178">
                            <img alt="" className="block w-full h-full" src={imgFromElements} />
                          </div>
                        ) : (
                          <div className={`bg-white border-[#c9cfd2] border-[1.003px] border-solid rounded-[100.324px] size-[20.065px] flex-shrink-0 ${selectedCategory === category ? 'border-[#0e1c47] border-[2px]' : ''}`} data-name="From Elements" />
                        )}
                        <input
                          type="radio"
                          name="category"
                          ...
                          className="hidden"
                        />
                        <p className={`font-['Poppins'] font-semibold leading-[20.065px] text-[13px] sm:text-[14.045px] ${idx === 0 ? 'text-[#191c1f]' : 'text-[#475156]'}`}>
                          {category}
                        </p>
                      </label>
                    ))}
                ...
                <div className="flex flex-col gap-[16.052px] items-start w-full" data-name="Price Range" data-node-id="35:4215">
                  <p className="font-['Poppins'] font-semibold leading-[24.078px] text-[#191c1f] text-[14px] sm:text-[16.052px] uppercase w-full" data-node-id="35:4216">
                    Price Range
                  </p>
                  ...
                  <div className="flex gap-[12.039px] items-start w-full" data-name="Input Field" data-node-id="35:4222">
                    <div className="bg-white border-[#e4e7e9] border-[1.003px] border-solid h-[40.129px] rounded-[3.01px] flex-1 relative" data-name="Min Price" data-node-id="35:4223">
                      <input
                        type="text"
                        placeholder="Min price"
                        className="absolute font-['Poppins'] font-semibold leading-[24.078px] left-[11.04px] text-[#77878f] text-[13px] sm:text-[14.045px] top-1/2 -translate-y-1/2 bg-transparent border-none outline-none w-[calc(100%-22px)]"
                        data-node-id="35:4224"
                      />
                    </div>
                    <div className="bg-white border-[#e4e7e9] border-[1.003px] border-solid h-[40.129px] rounded-[3.01px] flex-1 relative" data-name="Max Price" data-node-id="35:4225">
                      <input
                        type="text"
                    ...
                    {[
                      ...
                      >
                        ...
                        <input
                          ...
                          className="hidden"
                        />
                        <p className="font-['Poppins'] font-semibold leading-[20.065px] text-[#475156] text-[13px] sm:text-[14.045px]">
                          {range}
                        </p>
                      </label>
                    ))}
                ...
                <div className="flex flex-col gap-[16.052px] items-start w-full" data-name="Popular Brands" data-node-id="35:4250">
                  <p className="font-['Poppins'] font-semibold leading-[24.078px] text-[#191c1f] text-[14px] sm:text-[16.052px] uppercase w-full" data-node-id="35:4251">
                    popular Brands
                  </p>
                ...
                <div className="flex flex-col gap-[18.058px] items-start w-full" data-name="Popular Tag" data-node-id="35:4306">
                  <p className="font-['Poppins'] font-semibold leading-[24.078px] text-[#191c1f] text-[14px] sm:text-[16.052px] uppercase w-full" data-node-id="35:4307">
                    Popular Tag
                  </p>
